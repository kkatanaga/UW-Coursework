...
public abstract class Lab9ShapesKK {
...
class AxesShape extends Lab9ShapesKK {					// (Lab1) creates coordinate axes x, y, and z
...
class BaseShape extends Lab9ShapesKK {
	public BaseShape() {
...
class ColorString extends Lab9ShapesKK {
	String str;
	Color3f clr;
	double scl;
