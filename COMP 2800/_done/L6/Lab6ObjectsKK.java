...
public abstract class Lab6ObjectsKK {
...
//===============/!\ Lab 6 shapes /!\===============
class ShaftObjectA extends Lab6ObjectsKK {
	public ShaftObjectA() {
...
class MotorObjectA extends Lab6ObjectsKK {
	public MotorObjectA() {
...
class BladesObjectA extends Lab6ObjectsKK {
	public BladesObjectA() {
	...
	public TransformGroup position_Object() {              			// attach object BranchGroup "FanBlades" to 'objTG'
		Transform3D r_axis = new Transform3D();            			// default: rotate around Y-axis
		r_axis.rotZ(-Math.PI / 2.0f);                      			// rotate around z-axis for -90 degrees
...
class GuardObjectA extends Lab6ObjectsKK {
	public GuardObjectA() {
...
class StandObjectA extends Lab6ObjectsKK {
	public StandObjectA() {
...
class SwitchObjectA extends Lab6ObjectsKK {
