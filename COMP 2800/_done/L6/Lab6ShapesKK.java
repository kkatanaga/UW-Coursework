...
public abstract class Lab6ShapesKK {
...
class AxesShape extends Lab6ShapesKK {					// (Lab1) creates coordinate axes x, y, and z
...
class BaseShape extends Lab6ShapesKK {
	public BaseShape() {
...
class ColorString extends Lab6ShapesKK {
	String str;
	Color3f clr;
	double scl;
