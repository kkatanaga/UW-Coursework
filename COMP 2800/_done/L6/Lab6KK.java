...
public class Lab6KK extends JPanel {
	...
	private static TransformGroup create_Fan() {
		...
		object3D[1] = new SwitchObjectA();                 		// create "FanSwitch"
		object3D[2] = new ShaftObjectA();                 		// create "FanShaft"
		...
		object3D[3] = new MotorObjectA();                 		// create "FanMotor"
		object3D[2].add_Child(object3D[3].position_Object());	// attach "FanMotor" to "FanShaft"
		
		object3D[4] = new BladesObjectA();                 		// create "FanBlades"
		object3D[5] = new GuardObjectA();                 		// create "FanGuard"
		object3D[3].add_Child(object3D[4].position_Object());	// attach "FanBlades" to "FanMotor"
		object3D[3].add_Child(object3D[5].position_Object());	// attach "FanGuard" to "FanMotor"
		
		fanTG.addChild(create_Base("KK's Lab6"));          		// create and attach "FanBase" to "FanStand"
		return fanTG;
	}
