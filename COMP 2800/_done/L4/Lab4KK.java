...
public class Lab4KK extends JPanel {
	...
	public static BranchGroup create_Scene() {
		...
		sceneTG.addChild(new FoundationShape().position_Object());	// Foundation		/!\ Lab 4 /!\
		...
		sceneTG.addChild(new BladeShape().position_Object());		// Rotor Blades		/!\ Lab 4 /!\
		
		sceneTG.addChild(new StringShape("KK's Lab4").position_Object());
	...
	public Lab4KK(BranchGroup sceneBG) {
	...
	public static void main(String[] args) {
		frame = new JFrame("KK's Lab4");
		frame.getContentPane().add(new Lab4KK(create_Scene()));  // create an instance of the class
