...
public abstract class Lab8ShapesKK {
...
class AxesShape extends Lab8ShapesKK {					// (Lab1) creates coordinate axes x, y, and z
...
class BaseShape extends Lab8ShapesKK {
	public BaseShape() {
...
class ColorString extends Lab8ShapesKK {
	String str;
	Color3f clr;
	double scl;
