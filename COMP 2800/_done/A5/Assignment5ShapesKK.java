...
class BaseShape extends Assignment5ShapesKK {
	...
	protected Node create_Object() {
		...
		newTG.addChild(new StringShape("KK's Assignment 5").position_Object());	// stringTG
		winner = new Switch();
		
		Transform3D rotator = new Transform3D();
		rotator.rotY(Math.PI);
		TransformGroup emptyTG = new TransformGroup();
		TransformGroup player1 = new TransformGroup(rotator);
		TransformGroup player2 = new TransformGroup(rotator);
		
		player1.addChild(new StringShape("Player 1 Wins!").position_Object());
		player2.addChild(new StringShape("Player 2 Wins!").position_Object());
		
		winner.addChild(emptyTG);
		winner.addChild(player1);
		winner.addChild(player2);
		winner.setWhichChild(0);
		winner.setCapability(Switch.ALLOW_SWITCH_WRITE);
		
		newTG.addChild(winner);
		return newTG;
	}
...
class ChangeBackground extends Assignment5ShapesKK {
	protected Node create_Object() {
...
class CylinderShapes extends Assignment5ShapesKK {								// creates 4 cylinders using a shared group
...
class AxesShape extends Assignment5ShapesKK {				// copied from Lab1KK
...
class StringShape extends Assignment5ShapesKK {				// copied from Lab1KK; changed size, position, and orientation from original
