...
public abstract class Lab7ObjectsKK {
	...
	protected void rot_Object(int rot_rate, Transform3D axis) {
		objRG.setCapability(TransformGroup.ALLOW_TRANSFORM_WRITE);
		rotationAlpha = new Alpha(-1, rot_rate);
		
		RotationInterpolator rot_beh = new RotationInterpolator(rotationAlpha, objRG, axis, 0.0f, (float) Math.PI * 2.0f);
...
//===============/!\ Lab 7 shapes /!\===============
class ButtonObject extends Lab7ObjectsKK {
...
//===============/!\ Lab 6 shapes /!\===============
class ShaftObject extends Lab7ObjectsKK {
	public ShaftObject() {
...
class MotorObject extends Lab7ObjectsKK {
	public MotorObject() {
...
class BladesObject extends Lab7ObjectsKK {
	public BladesObject() {
...
class GuardObject extends Lab7ObjectsKK {
	public GuardObject() {
...
class StandObject extends Lab7ObjectsKK {
	public StandObject() {
...
class SwitchObject extends Lab7ObjectsKK {
	public SwitchObject() {
