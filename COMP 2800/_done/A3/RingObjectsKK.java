...
class ConcentricRing extends RingObjectsKK {
	...
	public ConcentricRing(Color3f colorOne, Color3f colorTwo) {
		concentricTG = new TransformGroup();
		
		TransformGroup centrRingTG = new RingShape(0.6f, new Vector3f(0f,  0.000f, -0.02110f), "Centr", colorTwo).position_Object();	// Center ring
		TransformGroup smallRingTG = new RingShape(0.7f, new Vector3f(0f,  0.000f, -0.03441f), "Small", colorOne).position_Object();	// Small ring
