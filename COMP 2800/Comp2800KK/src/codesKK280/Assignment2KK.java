...
public class Assignment2KK extends JPanel {
	...
	public static BranchGroup create_Scene() {
		...
		TransformGroup ring3TG = new Ring3Shape().position_Object();			// load Ring3.obj
		ring3TG.addChild(new Ring4Shape().position_Object());					// load Ring4.obj and it inherits Ring3's transformations
	...
	public Assignment2KK(BranchGroup sceneBG) {
		...
		CommonsKK.define_Viewer(su, new Point3d(4.0d, 0d, 1.0d));
