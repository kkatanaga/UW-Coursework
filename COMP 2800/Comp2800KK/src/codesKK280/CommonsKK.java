...
public class CommonsKK extends JPanel {
	...
	public CommonsKK(BranchGroup sceneBG) {
	...
	public static void main(String[] args) {
		frame = new JFrame("KK's Common File");            // NOTE: change XY to student's initials
		frame.getContentPane().add(new CommonsKK(create_Scene()));  // create an instance of the class
